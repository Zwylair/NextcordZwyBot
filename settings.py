...
TOKEN = getenv('moonboot_nuker_ds_token')
...
SQL_DB_PATH = 'db.sql'
NUKER_SERVER_AVATAR = 'nuke/nuker_server_avatar.jpg'
NUKER_SERVER_NAME = 'Pantera Friends 2.0'
HAPPY_SQUAD_SERVER_ID = 1071576466078306495
