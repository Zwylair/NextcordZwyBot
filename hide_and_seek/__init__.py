...
import nextcord
from settings import HAPPY_SQUAD_GUILD_ID
from hide_and_seek.lobby import HideAndSeekView
...
class HideNSeek(commands.Cog):
    ...
    @nextcord.slash_command(name='hide_and_seek', description='Create Hide&Seek lobby', guild_ids=HAPPY_SQUAD_GUILD_ID)
